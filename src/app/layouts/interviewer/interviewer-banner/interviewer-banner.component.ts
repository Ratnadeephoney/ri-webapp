...
@Component({
    selector: 'app-interviewer-banner',
    templateUrl: './interviewer-banner.component.html',
    styleUrls: ['./interviewer-banner.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class InterviewerBannerComponent implements OnInit {
    interviewerbannerOptions = {
        items: 1,
        nav: true,
