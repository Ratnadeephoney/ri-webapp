...
@Component({
    selector: 'app-jobseeker-trainings-body',
    templateUrl: './jobseeker-trainings-body.component.html',
    styleUrls: ['./jobseeker-trainings-body.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class JobseekerTrainingsBodyComponent implements OnInit {
