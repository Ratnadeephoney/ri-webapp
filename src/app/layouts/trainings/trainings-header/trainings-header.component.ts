...
@Component({
  selector: 'app-trainings-header',
  templateUrl: './trainings-header.component.html',
  styleUrls: ['./trainings-header.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class TrainingsHeaderComponent implements OnInit {
